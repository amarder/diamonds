...
On November 6, 2015, I downloaded data on all `r
my_format(nrow(diamonds))` round diamonds on Blue Nile. Below is a
...
Blue Nile's [diamond buying guide][buying-guide] describes that the
four C's (cut, color, clarity, and carat weight) are the most
important characteristics when buying a diamond. As a starting point
it seems reasonable to model price as a function of those four
characteristics.
