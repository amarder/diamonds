...
multiplicative model seems like a good choice. I model price as a product of
...
the observed variance in $\log(price_i)$!
...
focus %>% select(residual, carat, cut, color, clarity, price) %>% head(20)
```
