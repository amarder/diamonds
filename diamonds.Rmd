...
Are you looking to buy a diamond? This how-to guide describes three
...
On November 6, 2015, I downloaded data on all `r my_format(nrow(diamonds))`
round diamonds on Blue Nile. Below is a
...
characteristics when buying a diamond. It seems
reasonable to model price as a function of those four
characteristics. Having played around with the data bit, a
multiplicative model fits the data well. I model price as a product of
carat weight raised to the power $\beta$ times multipliers for the
cut, color, and clarity of the diamond
$$
...
Below is a summary of the fitted linear model. Generally, I try not to
focus much on R-squared values, but this model explains 91.5% of the
observed variance in $\log(price_i)$ using four variables!
